...
class SearchFilterSettings(BaseModel):
    ...
    btc_eth_hf_series_eth_5m: str = Field(default="10683", description="Polymarket series ID for ETH 5-min markets")
    btc_eth_hf_series_sol_5m: str = Field(default="10686", description="Polymarket series ID for SOL 5-min markets")
    btc_eth_hf_series_xrp_5m: str = Field(default="10685", description="Polymarket series ID for XRP 5-min markets")
