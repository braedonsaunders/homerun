...
class AppSettings(Base):
    ...
    btc_eth_hf_series_eth_5m = Column(String, default="10683")
    btc_eth_hf_series_sol_5m = Column(String, default="10686")
    btc_eth_hf_series_xrp_5m = Column(String, default="10685")
