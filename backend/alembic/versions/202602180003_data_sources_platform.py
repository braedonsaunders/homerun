...
def upgrade() -> None:
    ...
    if "data_sources" not in existing_tables:
        op.create_table(
            ...
            sa.Column("config", sa.JSON(), nullable=True, server_default=sa.text("'{}'")),
            sa.Column("config_schema", sa.JSON(), nullable=True, server_default=sa.text("'{}'")),
    ...
    if "data_source_records" not in existing_tables:
        op.create_table(
            ...
            sa.Column("geotagged", sa.Boolean(), nullable=False, server_default=sa.text("0")),
